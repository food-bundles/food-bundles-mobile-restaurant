...
export const settings: Record<keyof typeof settingsEn, string> = {
  ...
  ebm_pdf: 'PDF',
  ebm_downloadPdfLong: '↓ Télécharger le PDF',
  ebm_rraCertified: 'CERTIFIÉ RRA',
  ebm_invoicePreview: 'Aperçu de la facture EBM',
  ebm_invoiceNo: 'N° de facture',
  ebm_sdcId: 'ID SDC',
  ebm_receiptNo: 'N° de reçu',
  ebm_order: 'Commande',
  ebm_date: 'Date',
  ebm_buyer: 'Acheteur',
  ebm_customer: 'Client',
  ebm_customerTin: 'NIF du client',
  ebm_items: 'ARTICLES',
  ebm_colItem: 'Article',
  ebm_colQty: 'Qté',
  ebm_colAmount: 'Montant',
  ebm_colTax: 'Taxe',
  ebm_totalTaxCode: 'Total {{code}} : {{rate}} %',
  ebm_totalTax: 'Total taxe',
  ebm_totalRwf: 'TOTAL RWF',
  ebm_verifyCaption: 'Scannez pour vérifier avec la RRA',
